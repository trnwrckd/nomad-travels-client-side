...
const PlaceOrder = () => {
  ...
  const onSubmit = data => {
    ...
    axios.post(`${baseUrl}/orders`, data).then(res => {
            ...
            <div className='d-flex justify-content-center align-items-center'>
              <div className='img-parent'>
                <img
                  ...
                  alt=''
                  className='placeorder-img img-fluid '
                  height='300px'
                  width='450px'
                />
            ...
            <form onSubmit={handleSubmit(onSubmit)} className='form-group'>
              ...
              <div className='mb-2 d-flex flex-column flex-lg-row justify-content-evenly align-items-center'>
                ...
                <div className='d-flex align-items-center  mt-2 mt-lg-0'>
                  <button id='inc-btn' onClick={e => handleChangePersons(0, e)}>
                    -
                  </button>
                  <span id='persons'>{persons}</span>
                  <button id='dec-btn' onClick={e => handleChangePersons(1, e)}>
                    +
                  </button>
                </div>
              </div>
