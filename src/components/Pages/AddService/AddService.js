...
const AddService = () => {
  ...
  const onSubmit = (data) => {
    axios
      .post("https://enigmatic-caverns-80998.herokuapp.com/destinations", data)
      .then((res) => {
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="form-group">
            ...
            <div className="form-floating mb-2">
              <input
                ...
                data-toggle="tooltip"
                data-placement="left"
                title="Should be atleast 500 characters"
                type="text"
            ...
            <div className="form-floating mb-2">
              <input
                ...
                id="cost"
                {...register("costPerPerson", { required: "Cost is required" })}
              />
            ...
            <div className="form-floating mb-2">
              <input
                ...
                data-toggle="tooltip"
                data-placement="left"
                title="Minimum resolution 600*600"
                type="text"
            ...
            <div>
              <button className="btn-generic  btn-red">Add Service</button>
            </div>
          </form>
        </div>
      </div>
